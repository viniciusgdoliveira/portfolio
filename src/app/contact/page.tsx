              ...
              <form className="space-y-6">
                <div className="grid md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <input
                      ...
                      id="firstName"
                      name="firstName"
                      className="w-full px-4 py-3 liquid-glass-light rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-transparent text-slate-900 dark:text-white transition-all duration-300"
                      placeholder="John"
                    />
                  </div>
                  <div>
                ...
                <div>
                  ...
                  <textarea
                    ...
                    name="message"
                    rows={6}
                    className="w-full px-4 py-3 liquid-glass-light rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-transparent text-slate-900 dark:text-white transition-all duration-300 resize-none"
                ...
                <button
                  type="submit"
                  className="w-full liquid-button text-white font-semibold py-3 px-6 rounded-xl transition-all duration-300 hover:scale-105"
                >
                  Send Message
                </button>
              </form>
                ...
                <div className="space-y-6">
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-slate-600 dark:text-slate-300">hello@yourname.com</p>
                    </div>
                  </div>
