      ...
      <div className="liquid-card overflow-hidden hover:scale-105 transition-all duration-300">
        ...
        <div className="px-6 pt-4">
          <div className="flex space-x-1 liquid-glass-light rounded-xl p-1">
            <button
              ...
              className={`flex-1 py-2 px-3 rounded-lg text-xs font-medium transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 ${
                activeTab === 'image'
        ...
        <div className="p-6">
          ...
          <div className="flex space-x-3">
            <a
              href={project.github}
              className="flex items-center space-x-1 text-white/80 hover:text-white transition-colors text-sm focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 rounded-lg px-1 py-1"
            >
